    ...
    public Optional<PagingResult> page(PagingResult page, String soPhieuNhan, String nguoiGui,
        ...
        try {
            ...
            StringBuffer sqlBuffer = new StringBuffer("SELECT t.id,t.receipt_code,t.date_receipt,t.name_Stock,t.nha_xe,"
                    + " t.bien_so,t.employee,t.payer,t.payment_type,t.tien_da_tra,"
                    + " t.status,b.FULL_NAME as ten_nguoi_gui,b.address as dia_chi_nguoi_gui,c.FULL_NAME as ten_nguoi_nhan,c.address as dia_chi_nguoi_nhan, "
                    + " c.MOBILE as mobile_nguoi_nhan,   (select SUM(d.cost) FROM vt_receipt_detail d WHERE t.id = d.receipt_id) AS tong_tien "
