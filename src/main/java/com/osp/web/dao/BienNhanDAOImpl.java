...
public class BienNhanDAOImpl implements BienNhanDAO {
    ...
    public Optional<PagingResult> page(PagingResult page, String receiptCode, String nameStock,
        ...
        try {
            ...
            StringBuffer sqlBuffer = new StringBuffer("SELECT t.ID,t.receipt_code,t.date_receipt,t.name_Stock,t.nha_xe,t.bien_so,t.employee,t.payer,t.payment_type,t.payment_type,t.tien_da_tra,b.FULL_NAME as ten_nguoi_gui,b.address as dia_chi_nguoi_gui,c.FULL_NAME as ten_nguoi_nhan,c.address as dia_chi_nguoi_nhan, "
