 ...
 */
@Entity
@Table(name = "vt_gom_don_nhan")
@XmlRootElement
public class VtGomDonNhan implements Serializable {
    ...
    @Column(name = "id")
    private Integer id;
    @Column(name = "ma_gom_don")
    private String maGomDon;
    ...
    public VtGomDonNhan(Integer id) {
        this.id = id;
    }
    ...
    public String getMaGomDon() {
        return maGomDon;
    }

    public void setMaGomDon(String maGomDon) {
        this.maGomDon = maGomDon;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof VtGomDonNhan)) {
            return false;
        }
        VtGomDonNhan other = (VtGomDonNhan) object;
