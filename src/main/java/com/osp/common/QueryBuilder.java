...
public class QueryBuilder {
    ...
    public void and(String operator, String key, String prifixKeyParam, Object value) {
        this.sqlbuffer.append(" AND (");
        this.sqlbuffer.append(prifixKeyParam + " (" + key + ") ");
        this.sqlbuffer.append(" " + operator + " ");
        this.sqlbuffer.append(prifixKeyParam + " ( :param_" + (keys.size() + 1) + " ) ");
        this.sqlbuffer.append(" )");
        this.keys.add("param_" + (keys.size() + 1) + "");
        this.values.add(value);
    }
