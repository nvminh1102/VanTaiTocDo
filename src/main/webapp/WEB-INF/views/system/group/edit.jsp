    ...
    <section class="vbox">
        <section class="scrollable padder" style="background: white">
            ...
            <section class="panel panel-default">
                <header class="panel-heading"><h4><i class="fa fa-edit"></i> <spring:message code="label.edit.group.info"/></h4></header>
                    ...
                    <form method="post" action="<%=request.getContextPath()%>/system/group/edit" theme="simple"  enctype="multipart/form-data" class="form-horizontal" cssStyle="" validate="true">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group m-b">
                                        ...
                                        <input type="text" class="form-control input" value="${item.groupName}" name="groupName"/>
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-5">
                                <a href="<%=request.getContextPath()%>/system/group/list" class="btn btn-warning"><i class="fa fa-times"></i><spring:message code="message.modal.cancel"/></a>
                                <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i><spring:message code="label.button.add"/></button>
                            </div>
                        </div>
                    </form>
