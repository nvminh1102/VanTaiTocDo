...
<script src="<%=request.getContextPath()%>/assets/project/phieu-giao-hang/list.js${urlCache}" type="text/javascript"></script>
                        ...
                        <div class="panel-body background-xam">
                            <form class="form-horizontal">
                                ...
                                <div class="row" style="margin-top:10px;">
                                    <div class="col-md-6">
                                        <div class="col-md-4">
                                            <label class="control-label text-dark">Ngày lập phiếu</label>
                                        </div>
                                        <div class="col-md-8">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header alert-info">
                    ...
                    <h4 class="modal-title">Xóa phiếu giao hàng</h4>
                </div>
                <div class="modal-body">
                    <span>Bạn có chắc chắn muốn xóa phiếu giao hàng </span><span style="color: #3c763d">{{toaHangCode}}</span> <span> hay không?</span>
