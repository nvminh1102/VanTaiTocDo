                    ...
                    <form method="post" action="javascript:void(0)"  enctype="multipart/form-data" class="form-horizontal" id="addBienNhanForm" name="addBienNhanForm">
                        ...
                        <div class="row" style="padding-top: 1%;">
                            <div class="col-md-12" style="text-align: right">
                                <button type="button" class="btn btn-primary" style="width: 135px; background: #0e388c; margin-right: 15px; display: ${info.id != null ? "none" : ""}" data-toggle="modal" data-target="#addPropertyInfo"  ng-click="onAddProperty()">Thêm mặt hàng</button>
                            </div>
                        </div>
