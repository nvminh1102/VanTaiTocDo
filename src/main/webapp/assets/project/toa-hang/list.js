app.controller('vantai', ['$scope', '$http', '$timeout', '$q', function ($scope, $http, $timeout, $q) {
        ...
        $http.get(preUrl + "/managerVanTai/toa-hang/load-list", {params: {search: search, offset: 0, number: $scope.listData.numberPerPage}})
                .then(function (response) {
        ...
        $scope.loadPageData = function (index) {
            ...
            $http.get(preUrl + "/managerVanTai/toa-hang/load-list", {params: {search: search, offset: $scope.listData.numberPerPage * ($scope.listData.pageNumber - 1), number: $scope.listData.numberPerPage}})
                    .then(function (response) {
        ...
        $scope.exportPhieuBienNhan = function (toaHangId) {
            window.open(preUrl + "/managerVanTai/toa-hang/exportPhieuBienNhan?idToaHang=" + toaHangId, '_blank');
        }
        ...
        $scope.xoaToaHang = function () {
            ...
            $http.post(preUrl + "/managerVanTai/toa-hang/delete", vtToaHang, {headers: {'Content-Type': 'application/json'}})
                    .then(function (response) {
