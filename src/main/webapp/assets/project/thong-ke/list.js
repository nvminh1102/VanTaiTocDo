app.controller('frameworkCtrl', ['$scope', '$http', 'fileUpload', function ($scope, $http, fileUpload) {
        $scope.search = {bienSo: "", loaiXe: "", fromDate: "", toDate: ""};
        $scope.fromDate = '';
        $scope.toDate = '';
        $scope.page = page;
        ...
        $scope.exportExcel = function () {
            window.open(preUrl + "/managerVanTai/thong-ke/exportExcel?bienSo=" + $scope.search.bienSo
                    + "&loaiXe=" + $scope.search.loaiXe
                    + "&hinhThucVanChuyen=" + $scope.search.hinhThucVanChuyen
                    + "&fromDate=" + $scope.search.fromDate
                    + "&toDate=" + $scope.search.toDate, '_blank');
        }
