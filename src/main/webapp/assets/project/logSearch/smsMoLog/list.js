app.controller('frameworkCtrl',['$scope','$http','$filter','$window','$timeout','$q',function ($scope,$http,$filter,$window,$timeout,$q) {
    ...
    var urlSearch = "/system/sms-mo-log/list/search";
    ...
    $scope.loadListData=function () {
        $scope.searchvalue={};
        if(!isUndefined( $('#genlogmofrom').val())){
            $scope.searchvalue.gen_date_from=stringToDate($('#genlogmofrom').val(),'DD/MM/YYYY','/');
        }
        if(!isUndefined( $('#genlogmoto').val())){
            $scope.searchvalue.gen_date_to=stringToDate($('#genlogmoto').val(),'DD/MM/YYYY','/');
